...
# [ax.set_xlim(1991, 2019) for ax in axs]


axs[1].legend(loc = "lower left", frameon = false, bbox_to_anchor = (0.2, 0-.5), ncols = 3)
# fig.subplots_adjust(wspace = 0.25)
fig
fig.savefig(plotsdir("BRIN/1.HeatBudgetTimeSeries_complex_all_2panels.png"), bbox_inches = "tight", dpi = 400)
