...
fig, axs = plt.subplots(1, 3, figsize = (16, 8), sharex = false, sharey = true)
...
trends_df
[a.grid() for a in axs]
axs[2].legend(loc = "lower center", frameon = false, 
bbox_to_anchor = (0.5, -0.5), ncols = 3, prop = Dict("size"=> 15 ))
fig.tight_layout()
fig.subplots_adjust(wspace = 0.1)
fig
fig.savefig(plotsdir("BRIN/2.HeatBudgetTimeSeries_external_decomp_faces_all.png"), bbox_inches = "tight", dpi = 1000)
