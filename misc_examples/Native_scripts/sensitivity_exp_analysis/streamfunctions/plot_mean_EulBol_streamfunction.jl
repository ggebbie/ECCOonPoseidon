...
fig
fig.savefig(plotsdir("native/sensitivity_exps/ΨEulBol.png"))
...
vars =  ["only_init", "only_kappa", "only_sfc"]
plot_labels["SUM"] = "SUM"
for (i, expname) in enumerate(vars)
    Ψ_exp = 1e-6.* Ψ_means[expname]
...
fig
fig.savefig(plotsdir("native/sensitivity_exps/ΨEulBolDiff.png"))
