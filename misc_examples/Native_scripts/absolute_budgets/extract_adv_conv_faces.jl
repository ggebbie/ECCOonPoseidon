...
[ϕ_mask.f[ff] .= abs_dist.(ϕ.f[ff] .- 23.8, 0.1) .* PAC56_mask.f[ff] for ff in 1:2]
[ϕ_mask.f[ff] .= abs_dist.(ϕ.f[ff] .- 22.9, 0.1) .* PAC56_mask.f[ff] for ff in 4:5]
#22.9
ϕ_mask = ϕ_mask 
# ϕ_mask_max = 55.6; ϕ_max_mask = ϕ .> -Inf
