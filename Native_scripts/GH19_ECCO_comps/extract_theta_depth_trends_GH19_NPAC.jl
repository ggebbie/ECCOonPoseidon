...
PAC_msk = (23 .<= LATS .<= 64) .&& (115 .<= LONS .<= 300)
not_sel2 = Float32.((23 .<= LATS .<= 25) .&& (257 .<= LONS .<= 325)); not_sel2[isone.(not_sel2)] .= NaN
not_sel = Float32.((23 .<= LATS .<= 60) .&& (280 .<= LONS .<= 325)); not_sel[isone.(not_sel)] .= NaN
not_sel3 = Float32.((23 .<= LATS .<= 40) .&& (255 .<= LONS .<= 325)); not_sel3[isone.(not_sel3)] .= NaN
# not_sel4 = Float32.((-60 .<= LATS .<= -30) .&& (0 .<= LONS .<= 140)); not_sel4[isone.(not_sel4)] .= NaN

PAC_msk = PAC_msk .+ not_sel .+ not_sel2 .+ not_sel3
...
Challenger_times = findall(2010 .< year .< 2020)[end]
