...
adjust_exps["noinitadjust"] = get_temperature(diagpath, "noinitadjust", γ, cell_volumes)
adjust_exps["iter129_bulkformula"] = get_temperature(diagpath, "iter129_bulkformula", γ, cell_volumes)

jldsave(datadir(region * "_temperature_sens_exps_linearity_test.jld2"), adjust_exps= adjust_exps)
