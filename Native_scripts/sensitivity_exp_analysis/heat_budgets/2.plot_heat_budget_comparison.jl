...
exps =  ["iter0_bulkformula", "only_init", "only_kappa", "only_wind", "only_buoyancy"]
for (i, expname) in enumerate(exps)
...
fig
fig.savefig(plotsdir("native/sensitivity_exps/1.HeatBudgetTimeSeries.png"), bbox_inches = "tight")
