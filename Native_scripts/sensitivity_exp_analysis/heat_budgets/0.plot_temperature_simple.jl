...
fig
fig.savefig(plotsdir("native/sensitivity_exps/0.North_Pacific_Sens_Exps_T_simple.png"), bbox_inches = "tight")
...
ax.set_ylim(-0.8, 0.8)
fig
fig.savefig(plotsdir("native/sensitivity_exps/0.North_Pacific_Sens_Exps_ΔT_simple.png"), bbox_inches = "tight")
