...
smush_depths = OHC_helper.smush(cell_depths); 
...
masked_volume = cell_volumes[:, lvls] .* PAC_msk
...
jldsave(datadir("HeatBudgetApprox_"*region*"_full_2to3.jld2"); Advective_Heat_Budgets)
